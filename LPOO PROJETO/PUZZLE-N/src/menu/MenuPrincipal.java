...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==jogar) {
			this.save = new File("./src/JogosSalvos/JogoSalvo.txt");
			if(this.save.isFile()) {
				int resposta = JOptionPane.showConfirmDialog(null, "Gostaria de abrir o jogo salvo?", "AVISO", JOptionPane.YES_NO_OPTION);
				if(resposta == 0) {
					this.dispose();
